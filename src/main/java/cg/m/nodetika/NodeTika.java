...
public class NodeTika {
  ...
  public static String extractText(String uri, Map<String, Object> options) throws Exception {
    ...
    ContentHandler body = new BodyContentHandler(contentHandler);
    if (options.get("boilerpipe") != null && options.get("boilerpipe").toString() == "true") {
      body = new BoilerpipeContentHandler(contentHandler);
    }
